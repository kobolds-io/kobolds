...
pub const default_client_memory_pool_capacity: usize = 50_000;
...
pub const worker_outbox_capacity: usize = 100_000;
pub const worker_inbox_capacity: usize = 100_000;

pub const connection_outbox_capacity: usize = 50_000;
pub const connection_inbox_capacity: usize = 50_000;

pub const topic_max_queue_capacity: usize = 50_000;
pub const publisher_max_queue_capacity: usize = 5_000;
pub const subscriber_max_queue_capacity: usize = 50_000;

pub const service_max_requests_queue_capacity: usize = 10_000;
pub const service_max_replies_queue_capacity: usize = 10_000;
pub const advertiser_max_queue_capacity: usize = 10_000;
pub const requestor_max_queue_capacity: usize = 10_000;
