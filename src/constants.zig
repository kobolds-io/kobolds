...
pub const message_max_topic_name_size = 64; // 64 bytes
...
pub const connection_recv_buffer_size = 4096 * 1000;

/// The number of bytes used as the send buffer in each connection
pub const connection_send_buffer_size = 4096 * 1000;
...
pub const message_queue_capacity_max: u32 = 500_000;

/// Default size of a queue when no size is provided
pub const message_queue_capacity_default: u32 = 10_000;

/// Maximum size of the message pool
pub const message_pool_max_size: u32 = 50_000;
